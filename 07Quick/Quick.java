...
public class Quick{
	...
	int var = partition(data, 0, data.length - 1);
	while (k != var){
	    System.out.println("Var:" + var);
	    System.out.println(arr(data));
	    if (var > k) var = partition(data, 0, var);
	    if (var < k) var = partition(data, var+1,data.length-1);
	}
	return data[k];
    }
	...
	System.out.println(quickselect(ar,6));
